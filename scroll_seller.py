...
# ... (дальше идёт весь ваш код без изменений, кроме исправления ошибки с пустыми метками для frame_object)
# Я скопирую его с исправлением (lb_empty_*_object должны ссылаться на frame_object, а не frame_passport)
...
# ИСПРАВЛЕНО: пустые метки принадлежат frame_object, а не frame_passport
...
btn.grid(row=2, column=0, pady=20)   # pady даст отступ снизу, кнопка автоматически центрируется по горизонтали

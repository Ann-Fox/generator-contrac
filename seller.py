...
# Фрейм для ввода данных об объекте недвижимости
frame_object = tk.LabelFrame(window, text = "Объект недвижимости", font = frame_font)
frame_object.pack(padx = 100, pady = 20)

lb_empty_1_object = tk.Label(frame_passport, text = " ", font = label_font)
lb_empty_2_object = tk.Label(frame_passport, text = " ", font = label_font)
lb_empty_3_object = tk.Label(frame_passport, text = " ", font = label_font)
...
btn.pack(side = tk.TOP) #Размещаем кнопку в окне
